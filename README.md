...
As of today, 26 August 2025, IgH EtherCAT Master v1.6.7 supports all Ethernet drivers with kernels 6.1, 6.4, and 6.12 (obviously, if you know the Ethernet driver of your computer, it's enough to choose a kernel in which it is supported). Then check the long-term supported kernels, in this case 6.1 (End of life Dec 2027), 6.6 (EOL Dec 2026) and 6.12 (EOL Dec 2026).
...
Unfortunatly i downloaded the kernel... 
